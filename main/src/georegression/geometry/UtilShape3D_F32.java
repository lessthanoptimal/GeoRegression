...
public class UtilShape3D_F32 {
	 ...
	 * @param output
	 */
	public static void polygon2Dto3D(Polygon2D_F32 polygon2D , Se3_F32  polyToWorld , FastQueue<Point3D_F32> output )
	{
		output.resize(polygon2D.size());

		for (int i = 0; i < polygon2D.size(); i++) {
			Point2D_F32 p2 = polygon2D.get(i);
			Point3D_F32 p3 = output.get(i);
			p3.set(p2.x, p2.y,0);
			SePointOps_F32.transform(polyToWorld,p3,p3);
		}
	}
}
