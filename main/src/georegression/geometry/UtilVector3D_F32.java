...
public class UtilVector3D_F32 {
	 ...
	 */
	public static Vector3D_F32 perpendicularCanonical( Vector3D_F32 A , Vector3D_F32 output ) {
		if( output == null )
	 ...
	 * @return Matrix.
	 */
	public static FMatrixRMaj createMatrix( FMatrixRMaj R, Vector3D_F32... v ) {
		if( R == null ) {
