 ...
 * @see UtilLine2D_F64
 */
public class LineParametric2D_F64 implements Serializable, MapFormattable {
	/** A point on the line */
	...
	@Override public String formatMap( MapPrintFormat format ) {
		return format.itemPrefix +
				"line" + format.valueSeparator + p.formatMap(format) + format.pairSeparator +
				"slope" + format.valueSeparator + slope.formatMap(format) +
				format.itemSuffix;
	}
