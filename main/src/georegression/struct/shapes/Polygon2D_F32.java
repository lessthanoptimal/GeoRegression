...
public class Polygon2D_F32 implements Serializable {
	...
	public Polygon2D_F32( float... points ) {
		...
		vertexes = new FastQueue<Point2D_F32>(points.length/2,Point2D_F32.class,true);
	...
	public Polygon2D_F32() {
		vertexes = new FastQueue<>(Point2D_F32.class,true);
	}
	 ...
	 * or outside.
	 *
	 * @see Intersection2D_F32#containConcave(Polygon2D_F32, Point2D_F32)
	 * @see Intersection2D_F32#containConcave(Polygon2D_F32, Point2D_F32)
	 *
	 * @param p A point
