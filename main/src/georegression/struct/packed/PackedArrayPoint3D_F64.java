 ...
 * @author Peter Abeles
 */
public class PackedArrayPoint3D_F64 extends PackedArray_F64<Point3D_F64> implements MapFormattable {
	...
	@Override public void forIdx( int idx0, int idx1, ProcessIndex<Point3D_F64> op ) {
		int pointIndex = idx0;
		idx0 *= DOF;
		idx1 *= DOF;
	...
	@Override public String formatMap( MapPrintFormat format ) {
		return formatMap(format, new String[]{"x", "y", "z"});
	}
