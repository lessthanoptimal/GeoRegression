 ...
 * @author Peter Abeles
 */
public class PackedArrayPoint4D_F64 extends PackedArray_F64<Point4D_F64> implements MapFormattable {
	...
	@Override public PackedArrayPoint4D_F64 reset() {
		array.reset();
		return this;
	}

	@Override public PackedArrayPoint4D_F64 reserve( int numTuples ) {
	...
	@Override public void forIdx( int idx0, int idx1, ProcessIndex<Point4D_F64> op ) {
		int pointIndex = idx0;
		idx0 *= DOF;
		idx1 *= DOF;
	...
	@Override public String formatMap( MapPrintFormat format ) {
		return formatMap(format, new String[]{"x", "y", "z", "w"});
	}
