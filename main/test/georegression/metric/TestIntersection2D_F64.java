...
public class TestIntersection2D_F64 {
	...
	@Test void containsConvex() {
		...
		var online = new Point2D_F64(1, -1);
		var inside = new Point2D_F64(0.5, 0.5);
		var outside = new Point2D_F64(1.5, 0.5);
	...
	@Test void intersection_p_to_ls() {
		var paraLine = new LineParametric2D_F64();
		var target = new LineSegment2D_F64(-1, 1, 1, 1);

		var tran = new Se2_F64();
	...
	@Test void intersection_l_to_l_parametric_pt() {
		var a = new LineParametric2D_F64(2, 3, 1, 0);
		var b = new LineParametric2D_F64(-2, -4, 0, 1);
		...
		var c = new LineParametric2D_F64(-8, 2, 0, 1);
	...
	@Test void intersection_l_to_l_parametric_t() {
		...
		var found = new Point2D_F64(2 + t, 3);
	...
	@Test void intersection_l_to_l_points() {
		var a0 = new Point2D_F64(3, 20);
		var a1 = new Point2D_F64(10, 20);
		var b0 = new Point2D_F64(7, 5);
		var b1 = new Point2D_F64(8, 30);

		var a = new LineParametric2D_F64(a0, new Vector2D_F64(a1.x - a0.x, a1.y - a0.y));
		var b = new LineParametric2D_F64(b0, new Vector2D_F64(b1.x - b0.x, b1.y - b0.y));
	...
	@Test void intersection_l_to_l_general_3D() {
		...
		var a = new LineGeneral2D_F64(1, 2, 3);
		var b = new LineGeneral2D_F64(2, -1, 0.5);
	...
	@Test void contains_rectLength_pt() {
		var rect = new RectangleLength2D_F64(-10, -5, 5, 10);
	...
	@Test void contains_rect_pt() {
		var rect = new Rectangle2D_F64(-10, -5, -5, 5);
	...
	@Test void intersects_lineseg_rect() {
		...
		assertFalse(Intersection2D_F64.intersects(new LineSegment2D_F64(-2, 5, 2, 5), rect, tol));
		assertFalse(Intersection2D_F64.intersects(new LineSegment2D_F64(5, -3, 5, 3), rect, tol));

		// End points of line is completely outside the rectangle
		assertTrue(Intersection2D_F64.intersects(new LineSegment2D_F64(-2, 1, 2, 2), rect, tol));
		assertTrue(Intersection2D_F64.intersects(new LineSegment2D_F64(0, -3, 0, 3), rect, tol));

		// End points of line is completely inside the rectangle
		assertTrue(Intersection2D_F64.intersects(new LineSegment2D_F64(-0.5, 1, 0.5, 2), rect, tol));
		assertTrue(Intersection2D_F64.intersects(new LineSegment2D_F64(0, -1, 0, 1), rect, tol));

		// NOTE: If the border is inclusive or exclusive isn't specified and there are not test for that case
	}
	...
	@Test void intersection_poly_to_poly_Simple() {
		...
		var A = new Polygon2D_F64(new double[][]{{0, 0}, {4, 0}, {4, 4}, {2, 2}, {0, 4}});
		Polygon2D_F64 B = A.copy();
	...
	@Test void line_ellipse() {
		...
		var ellipse = new EllipseRotated_F64(0, 0, 2, 1, 0);
