...
public class TestClosestPoint3D_F64 extends GeoRegressionJUnit {
	...
	@Test void closestPoint_line_Homogenous() {
		Point3D_F64 a = new Point3D_F64(1, 1, 1);
		Point3D_F64 b = new Point3D_F64(1.5, -2.5, 9);
		Point3D_F64 c = new Point3D_F64(10.1, 6, -3);
	...
	@Test void closestPoints_line_Homogenous() {
		var a = new Point3D_F64(1, 1, 1);
		var b = new Point3D_F64(1.5, -2.5, 9);
		var c = new Point3D_F64(10.1, 6, -3);

		var va = new Vector3D_F64(a, b);
		var vc = new Vector3D_F64(c, b);

		var lineA = new LineParametric3D_F64(a, va);
		var lineB = new LineParametric3D_F64(c, vc);

		var foundA = new Point4D_F64();
		var foundB = new Point4D_F64();

		// Check a situation where they intersect, and not at infinity
		ClosestPoint3D_F64.closestPoints(lineA, lineB, foundA, foundB);

		// They should be the same point and normalized
		assertEquals(0.0, foundA.distance(foundB), GrlConstants.TEST_F64);

		// The answer is known to be 'b'
		assertEquals(0.0, UtilPoint3D_F64.distance(b.x, b.y, b.z, foundA.x/foundA.w,
				foundA.y/foundA.w, foundA.z/foundA.w), GrlConstants.TEST_F64);

		// Check parallel lines
		var lineC = new LineParametric3D_F64(1, 2, 3, 1, -1, 2);
		var lineD = new LineParametric3D_F64(3, 2, 3, 1, -1, 2);

		ClosestPoint3D_F64.closestPoints(lineC, lineD, foundA, foundB);

		// Make it a regular 3D point
		foundA.divideIP(foundA.w);
		foundB.divideIP(foundB.w);

		// Compute distance
		double d = UtilPoint3D_F64.distance(foundA.x, foundA.y, foundA.z, foundB.x, foundB.y, foundB.z);

		// Any two closest points between the line should match
		double e = Distance3D_F64.distance(lineC, lineD.getPointOnLine(1.2));

		assertEquals(d, e, GrlConstants.TEST_F64);
	}

	@Test void closestPoints_lines() {
		Point3D_F64 a = new Point3D_F64(1, 1, 1);
		Point3D_F64 b = new Point3D_F64(1.5, -2.5, 9);
		Point3D_F64 c = new Point3D_F64(10.1, 6, -3);
	...
	@Test void closestPoint_point_d() {
		Point3D_F64 a = new Point3D_F64(1, 1, 1);
		Point3D_F64 b = new Point3D_F64(1.5, -2.5, 9);
		Point3D_F64 c = new Point3D_F64(10.1, 6, -3);
	...
	@Test void closestPoint_planeNorm_point() {
		Point3D_F64 found;
	...
	@Test void closestPoint_planeGen_point() {
		Point3D_F64 found;
	...
	@Test void closestPoint_lineSeg_pt() {
	...
	@Test void closestPointT_lineSeg_pt() {
	...
	@Test void closestPoint_lineSeg_lineSeg() {
		Point3D_F64 found;
	...
	@Test void closestPoint_triangle_point() {
	...
	@Test void closestPointT_line_plane() {
	...
	@Test void closestPointT_line_point() {
		Point3D_F64 a = new Point3D_F64(1, 1, 1);
		Point3D_F64 b = new Point3D_F64(1.5, -2.5, 9);
		Point3D_F64 c = new Point3D_F64(10.1, 6, -3);
