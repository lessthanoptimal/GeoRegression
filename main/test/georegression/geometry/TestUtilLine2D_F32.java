...
public class TestUtilLine2D_F32 {
	...
	public void convert_segment_parametric() {
		...
		assertEquals(para.p.x,1, GrlConstants.TEST_F32);
		assertEquals(para.p.y,2, GrlConstants.TEST_F32);
		assertEquals(para.slope.x,4, GrlConstants.TEST_F32);
		assertEquals(para.slope.y,-2, GrlConstants.TEST_F32);
	}
	...
	public void convert_segment2pt_parametric() {
		...
		LineParametric2D_F32 para = UtilLine2D_F32.convert(a,b,(LineParametric2D_F32) null);

		assertEquals(para.p.x,2, GrlConstants.TEST_F32);
		assertEquals(para.p.y,6, GrlConstants.TEST_F32);
		assertEquals(para.slope.x,5, GrlConstants.TEST_F32);
		assertEquals(para.slope.y,2, GrlConstants.TEST_F32);
	}
