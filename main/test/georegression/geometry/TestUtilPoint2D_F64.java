...
public class TestUtilPoint2D_F64 extends GeoRegressionJUnit {
	...
	@Test void noiseNormal_single() {
		...
		assertEquals(mean.x, found.x, 0.02);
		assertEquals(mean.y, found.y, 0.02);
	...
	@Test void orderCCW() {
		...
		assertSame(found.get(0), input.get(2));
		assertSame(found.get(1), input.get(0));
		assertSame(found.get(2), input.get(1));
		assertSame(found.get(3), input.get(3));
	}

	@Test void create_and_compute_normal2D() {
