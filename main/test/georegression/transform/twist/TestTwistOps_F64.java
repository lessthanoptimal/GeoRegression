...
public class TestTwistOps_F64 {
	...
	public void homogenous_se3() {
		...
		DenseMatrix64F H = TwistOps_F64.homogenous(original,null);
	...
	public void homogenous_twist() {
		...
		DenseMatrix64F H = TwistOps_F64.homogenous(twist,null);
	...
	public void exponential_twist_pure_r() {
		...
		assertTrue(MatrixFeatures.isIdentical(expected.R,found.R, GrlConstants.DOUBLE_TEST_TOL));
	...
	@Test
	public void exponential_to_twist_verse() {
		...
		TwistCoordinate_F64 foundTwist = new TwistCoordinate_F64();
		double foundTheta = TwistOps_F64.twist(se3, foundTwist);
		...
		assertEquals( theta, foundTheta, GrlConstants.DOUBLE_TEST_TOL );
	}
}
