...
public class TestTwistOps_F32 {
	...
	public void exponential_twist_pure_r() {
		...
		assertTrue(MatrixFeatures.isIdentical(expected.R,found.R, GrlConstants.FLOAT_TEST_TOL));
	...
	public void exponential_to_twist_verse() {
		...
		TwistCoordinate_F32 foundTwist = new TwistCoordinate_F32();
		float foundTheta = TwistOps_F32.twist(se3, foundTwist);
		...
		assertEquals( theta, foundTheta, GrlConstants.FLOAT_TEST_TOL );
	}
}
