...
public class TestModelManagerPlaneGeneral3D_F32 {
	...
	public void copyModel() {
		...
		assertEquals(model.A,found.A, GrlConstants.TEST_F32);
		assertEquals(model.B,found.B, GrlConstants.TEST_F32);
		assertEquals(model.C,found.C, GrlConstants.TEST_F32);
		assertEquals(model.D,found.D, GrlConstants.TEST_F32);
	}
