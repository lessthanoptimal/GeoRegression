...
* `Source Code <http://sourceforge.net/projects/georegression/files/0.14/georegression-v0.14-src.zip/download>`_
* `Precompiled Jar and Dependencies <http://sourceforge.net/projects/georegression/files/0.14/georegression-v0.14-libs.zip/download>`_
