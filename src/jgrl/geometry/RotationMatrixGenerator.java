...
public class RotationMatrixGenerator {
    ...
    /**
     * Converts {@link jgrl.struct.so.Rodrigues} into a rotation matrix.
     *
    ...
    public static DenseMatrix64F rodriguesToMatrix( Rodrigues rodrigues, DenseMatrix64F R)
    {
        ...
        R.set(0,0, c + x*x*oc);   R.set(0,1, x*y*oc - z*s);    R.set(0,2, x*z*oc + y*s);
        R.set(1,0, y*x*oc + z*s); R.set(1,1, c + y*y*oc);      R.set(1,2, y*z*oc - x*s);
        R.set(2,0, z*x*oc - y*s); R.set(2,1, z*y*oc + x*s);    R.set(2,2, c + z*z*oc);
    ...
    /**
     * <p>
     * Converts {@link Rodrigues} into {@link jgrl.struct.so.Quaternion}.
     * </p>
     *
     * <p>
    ...
    /**
     * Converts a rotation matrix into {@link jgrl.struct.so.Rodrigues}.
     *
     * @param R Rotation matrix.
