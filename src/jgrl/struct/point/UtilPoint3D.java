...
public class UtilPoint3D {
    ...
    public static void noiseNormal_F64( List<Point3D_F64> pts , double sigma , Random rand ) {
        for( Point3D_F64 p : pts ) {
    ...
    public static List<Point3D_F64> random_F64( double min , double max , int num , Random rand ) {
        List<Point3D_F64> ret = new ArrayList<Point3D_F64>();
