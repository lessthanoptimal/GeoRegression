 ...
 * @author Peter Abeles
 */
public class SpecialEuclideanOps {
     ...
     */
    public static void setToNoMotion( Se3 se ) {
     ...
     */
    public static DenseMatrix64F toHomogeneous(Se3 se , DenseMatrix64F ret ) {
        if( ret == null )
     ...
     * @return equivalent homogeneous transform.
     */
    public static DenseMatrix64F toHomogeneous(Se2 se , DenseMatrix64F ret ) {
        if( ret == null )
    ...
    /**
     * Converts a homogeneous representation into {@link Se2}.
     *
     * @param H Homogeneous 3 by 3 matrix.
     * @param ret If not null where the results are written to.
     * @return Se3 transform.
     */
    public static Se2 toSe2(DenseMatrix64F H , Se2 ret ) {
    ...
    /**
     * Sets the value of an {@link Se3} using Euler XYZ coordinates for the rotation and
     ...
     */
    public static Se3 setEulerXYZ(double rotX, double rotY, double rotZ,
