...
public class SePointOps {
     ...
     */
    public static Point2D_F64 transform( Se2 se , Point2D_F64 orig , Point2D_F64 result ) {
    ...
    public static Point2D_F64 transform( Se2 se , double x , double y , Point2D_F64 result ) {
    ...
    public static Point2D_F64 transformReverse( Se2 se , Point2D_F64 orig , Point2D_F64 result ) {
     ...
     */
    public static void transform( Se2 se , Point2D_F64 points[] , int length ) {
     ...
     */
    public static void transform( Se2 se , List<Point2D_F64> points) {
     ...
     * @return Transformed point.
     */
    public static Point3D_F64 transform( Se3 se , Point3D_F64 origPt , Point3D_F64 tranPt )
    {
        if( tranPt == null )
        ...
        GeometryMath.rotate(R,origPt, tranPt,true);
        GeometryMath.add(tranPt,T, tranPt);
     ...
     */
    public static Point3D_F64 transformReverse( Se3 se , Point3D_F64 origPt , Point3D_F64 tranPt )
    {
        if( tranPt == null )
            tranPt = new Point3D_F64();
        ...
        GeometryMath.sub(origPt,T,tranPt);
        GeometryMath.rotate(R,tranPt,tranPt,false);
