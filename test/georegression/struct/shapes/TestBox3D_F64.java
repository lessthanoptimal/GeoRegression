...
public class TestBox3D_F64 {
	...
	public void constructor_box() {
		...
		assertEquals(1,box.p0.x, GrlConstants.DOUBLE_TEST_TOL);
		assertEquals(2,box.p0.y, GrlConstants.DOUBLE_TEST_TOL);
		assertEquals(3,box.p0.z, GrlConstants.DOUBLE_TEST_TOL);
		assertEquals(4,box.p1.x, GrlConstants.DOUBLE_TEST_TOL);
		assertEquals(5,box.p1.y, GrlConstants.DOUBLE_TEST_TOL);
		assertEquals(6,box.p1.z, GrlConstants.DOUBLE_TEST_TOL);
	}
	...
	public void area() {
		...
		assertEquals(expected,box.area(),GrlConstants.DOUBLE_TEST_TOL);
	}
	...
	public void getLengthX() {
		...
		assertEquals(3,box.getLengthX(),GrlConstants.DOUBLE_TEST_TOL);
	}
	...
	public void getLengthY() {
		...
		assertEquals(4,box.getLengthY(),GrlConstants.DOUBLE_TEST_TOL);
	}
	...
	public void getLengthZ() {
		...
		assertEquals(5,box.getLengthZ(),GrlConstants.DOUBLE_TEST_TOL);
	}
