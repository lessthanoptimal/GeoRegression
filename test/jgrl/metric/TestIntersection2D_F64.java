   ...
   Random rand = new Random(234);
    ...
    public void checkIntersection( LineSegment2D_F64 a , LineSegment2D_F64 b , Point2D_F64 expected )
    {
        ...
        if( found == null )
            ...
            assertEquals(found.getX(),expected.getX(),1e-8);
            assertEquals(found.getY(),expected.getY(),1e-8);
        }
    ...
    private void checkIntersection_p_to_ls( LineParametric2D_F64 paraLine ,
        ...
        paraLine.setPoint(SePointOps.transform(tran,paraLine.getPoint(),null));

        target.setA(SePointOps.transform(tran,target.getA(),null));
        target.setB(SePointOps.transform(tran,target.getB(),null));
