...
public abstract class GenericInvertibleTransformTests_F64<T extends GeoTuple_F64> {
	...
	public void testReset() {
		...
		assertFalse(orig.isIdentical(before, JgrlConstants.DOUBLE_TEST_TOL));

		// after reset it shouldn't modify the point
		tran1.reset();
		apply(tran1, orig, before);
		assertTrue(orig.isIdentical(before, JgrlConstants.DOUBLE_TEST_TOL));
	}
	...
	public void testInvert() {
		...
		assertTrue(found.isIdentical(orig, JgrlConstants.DOUBLE_TEST_TOL));
