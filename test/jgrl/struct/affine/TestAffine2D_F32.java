...
public class TestAffine2D_F32 extends GenericInvertibleTransformTests_F32<Point2D_F32> {
	...
	public Affine2D_F32 createRandomTransform() {
		...
		float a11 = (float) rand.nextGaussian() * 3.0f;
		float a12 = (float) rand.nextGaussian() * 3.0f;
		float a21 = (float) rand.nextGaussian() * 3.0f;
		float a22 = (float) rand.nextGaussian() * 3.0f;
		float tx = (float) rand.nextGaussian() * 3.0f;
		float ty = (float) rand.nextGaussian() * 3.0f;
