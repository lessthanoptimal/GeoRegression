...
public class TestGeometryMath {
    ...
    public void crossMatrix() {
        ...
        GeometryMath.cross(v,x,found0);
        DenseMatrix64F V = GeometryMath.crossMatrix(a,b,c,null);

        GeometryMath.mult(V,x,found1);
    ...
    public void _rotate() {
        ...
        GeometryMath.rotate(M,pt,pt,true);
    ...
    public void innerProd_3D() {
        ...
        double found = GeometryMath.innerProd(a,M,b);
    ...
    public void innerProdTranM() {
        ...
        double found = GeometryMath.innerProdTranM(a,M,b);
    ...
    public void dot() {
        Vector3D_F64 a = new Vector3D_F64(2,-2,3);
        Vector3D_F64 b = new Vector3D_F64(4,3,2);
        double found = GeometryMath.dot(a,b);
