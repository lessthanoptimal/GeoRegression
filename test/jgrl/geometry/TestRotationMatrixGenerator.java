...
public class TestRotationMatrixGenerator {
    ...
    public void rotX() {
        ...
        GeometryMath.rotate(R,pt_y,pt_y,true);
        GeometryMath.rotate(R,pt_z,pt_z,true);
    ...
    public void rotY() {
        ...
        GeometryMath.rotate(R,pt_x,pt_x,true);
        GeometryMath.rotate(R,pt_z,pt_z,true);
    ...
    public void eulerXYZ() {
        ...
        GeometryMath.rotate(R,pt_expected,pt_expected,true);
        GeometryMath.rotate(xyz,pt_found,pt_found,true);
